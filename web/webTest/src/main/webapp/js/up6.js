...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		, "LogFile"			: "h:\\upload\log\log.txt"//日志文件路径。需要先打开调试模式。
		...
		//文件夹操作相关
		, "UrlFdCreate"		: "http://localhost/db/fd_create_uuid.jsp"
		, "UrlFdComplete"	: "http://localhost/db/fd_complete.jsp"
		, "UrlFdDel"	    : "http://localhost/db/fd_del.jsp"
		//文件操作相关
		, "UrlCreate"		: "http://localhost/db/f_create.jsp"
		, "UrlPost"			: "http://localhost/db/f_post.jsp"
        , "UrlProcess"		: "http://localhost/db/f_process.jsp"
		, "UrlComplete"		: "http://localhost/db/f_complete.jsp"
		, "UrlList"			: "http://localhost/db/f_list.jsp"
		, "UrlDel"			: "http://localhost/db/f_del.jsp"
	    //x86
        // , ie: {
