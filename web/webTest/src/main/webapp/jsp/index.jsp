...
<body>
<p>上传下载文件页面</p>
<p><a href="/jsp/db/sql.jsp" target="_blank">初始化数据库</a>：用于创建数据表和存储过程，在首次使用时操作。需要先配置数据库连接信息。</p>
<p><a href="/db/clear.jsp" target="_blank">清空数据库</a></p>
<p><a href="/html/index-single.htm" target="_blank">打开单文件上传页面</a></p>
<p><a href="/html/down2/index.htm" target="_blank">打开下载页面</a></p>
<p>
    文件路径：<input id="filePath" type="text" size="50" value="h:\\upload\1.text"/>&nbsp;
    <input id="btnUpF" type="button" value="上传本地文件"/>
</p>
<p>
    目录路径：<input id="folderPath" type="text" size="50" value="h:\\upload"/>&nbsp;
